...
////////////////////////////////////////////////////////////////////////////////
bool CxImage::EncodeSafeCheck(CxFile *hFile) const
{
	if (hFile==NULL) {
 ...
 * \return true if everything is ok
 */
bool CxImage::Encode(FILE *hFile, uint32_t imagetype) const
{
	CxIOFile file(hFile);
 ...
 * \return true if everything is ok
 */
bool CxImage::Encode(uint8_t * &buffer, int32_t &size, uint32_t imagetype) const
{
	if (buffer!=NULL){
 ...
 */
bool CxImage::Encode(CxFile *hFile, uint32_t imagetype) const
{
 ...
 * \return true if everything is ok
 */
bool CxImage::Encode(FILE * hFile, CxImage ** pImages, int32_t pagecount, uint32_t imagetype) const
{
	CxIOFile file(hFile);
 ...
 * \return true if everything is ok
 */
bool CxImage::Encode(CxFile * hFile, CxImage ** pImages, int32_t pagecount, uint32_t imagetype) const
{
#if CXIMAGE_SUPPORT_TIF
 ...
 * \return true if everything is ok
 */
bool CxImage::Encode2RGBA(uint8_t * &buffer, int32_t &size, bool bFlipY) const
{
	if (buffer!=NULL){
		strcpy(info.szLastError,"the buffer must be empty");
		return false;
 ...
 * \return true if everything is ok
 */
bool CxImage::Encode2RGBA(CxFile *hFile, bool bFlipY) const
{
