...
/** \addtogroup Initialization */ //@{
	...
	void	FreeMemory(void* memblock) const;
...
/** \addtogroup Attributes */ //@{
	...
	void	SetJpegQuality(uint8_t q) const;
	float	GetJpegQualityF() const;
	void	SetJpegQualityF(float q) const;
...
/** \addtogroup Pixel */ //@{
	...
	RGBQUAD GetPixelColor(int32_t x,int32_t y, bool bGetAlpha = true) const;
	uint8_t	GetPixelIndex(int32_t x,int32_t y) const;
	uint8_t	GetPixelGray(int32_t x, int32_t y) const;
...
/** \addtogroup Protected */ //@{
	uint8_t BlindGetPixelIndex(const int32_t x,const int32_t y) const;
	RGBQUAD BlindGetPixelColor(const int32_t x,const int32_t y, bool bGetAlpha = true) const;
	void *BlindGetPixelPointer(const int32_t x,const  int32_t y) const;
...
protected:
/** \addtogroup Protected */ //@{
	bool EncodeSafeCheck(CxFile *hFile) const;
//@}
...
/** \addtogroup Encode */ //@{
	...
	bool Encode(FILE * hFile, uint32_t imagetype) const;
	bool Encode(CxFile * hFile, uint32_t imagetype) const;
	bool Encode(CxFile * hFile, CxImage ** pImages, int32_t pagecount, uint32_t imagetype) const;
	bool Encode(FILE *hFile, CxImage ** pImages, int32_t pagecount, uint32_t imagetype) const;
	bool Encode(uint8_t * &buffer, int32_t &size, uint32_t imagetype) const;

	bool Encode2RGBA(CxFile *hFile, bool bFlipY = false) const;
	bool Encode2RGBA(uint8_t * &buffer, int32_t &size, bool bFlipY = false) const;
//@}
...
/** \addtogroup Alpha */ //@{
	...
	uint8_t AlphaGet(const int32_t x,const int32_t y) const;
	uint8_t AlphaGetMax() const;
	void AlphaSetMax(uint8_t nAlphaMax);
	bool AlphaIsValid() const;
...
protected:
/** \addtogroup Protected */ //@{
	uint8_t BlindAlphaGet(const int32_t x,const int32_t y) const;
//@}
...
/** \addtogroup Protected */ //@{
	...
	mutable CXIMAGEINFO			info; //extended information
